package com.javatpoint.user.tic_tac_toegame;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        System.out.println("ccccccccccccccc "+roundCount);
        ...
        {
            ((Button) v).setText("X");
            System.out.println(" X "+roundCount);
        }
        else {
            ((Button) v).setText("o");
            System.out.println(" o "+roundCount);
        }
        roundCount++;
